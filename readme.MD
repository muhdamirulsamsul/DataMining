...
* APK: <a href="https://github.com/muhdamirulsamsul/DataMining/blob/master/myapp-1.0-armeabi-v7a-debug.apk">APK file</a> (Note: May not compatible with some android versions)
