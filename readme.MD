...
In this part, we will crawl the data needed using some libraries from Python like BeautifulSoup and Selenium. Further explanation can be seen in the following links.
